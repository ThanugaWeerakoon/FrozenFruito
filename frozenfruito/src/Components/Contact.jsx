    ...
    >
      ...
      <div className="text-center">
        <input
          type="submit"
          value="Send"
          className="bg-blue-500 text-white font-bold py-2 px-4 rounded-lg shadow hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50 cursor-pointer"
        />
      </div>
    </form>
  );
