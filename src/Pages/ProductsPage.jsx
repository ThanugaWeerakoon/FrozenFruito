      ...
      <div className="bg-gray-50 py-12">
        <div className="container mx-auto px-4">
          ...
          <p className="text-center text-green-800 text-lg mb-16">
            Discover our range of natural and healthy fruit pulps, perfect for a
            variety of uses.
          </p>
